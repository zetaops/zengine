...
class TaskManagerActionsView(CrudView):
    ...
    # - Assign Yourself -
    def control_task_invitation(self):
        ...
        if not wfi.current_actor.exist:
            ...
            self.current.task_data['actions'] = True
        else:
            self.current.task_data['actions'] = False
            self.current.task_data['current_actor_key'] = wfi.current_actor.key

    def show_message(self):
        if self.current.task_data['actions']:
            self.output['msgbox'] = {
                'type': 'info', "title": "Successful",
                "msg": ""
            }
        else:
            self.output['msgbox'] = {
                'type': 'info', "title": "Unsuccessful",
                "msg": ""
            }
    # - Assign Yourself -
